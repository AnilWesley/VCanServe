...
public interface SecurityGuardScreenContract {
    ...
    interface IPresenter {
        ...
        void savedomesticservice_help(Context context, APIResponseCallback apiResponseCallback, JSONObject requestBody);
