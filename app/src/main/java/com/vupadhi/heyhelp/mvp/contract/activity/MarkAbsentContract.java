...
public interface MarkAbsentContract {
    ...
    interface IPresenter {
        ...
        void saveworkerabsence_list(Context context, APIResponseCallback apiResponseCallback, JSONObject requestBody);
        void getworkerlist(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody,String id);
