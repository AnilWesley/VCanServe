...
public interface OtpActivityContract {
    ...
    interface IPresenter {
        ...
        void verify_otp(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void resend_otp(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody,String id);
