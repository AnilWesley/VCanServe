...
public interface FeedbackDomesticHelpScreenContract {
    ...
    interface IPresenter {
        ...
        void feedback_questions(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody,String id);
        void savefeedback(Context context, APIResponseCallback apiResponseCallback, JSONObject requestBody);
