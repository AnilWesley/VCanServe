...
public interface RateandReviewActivityContract {
    ...
    interface IPresenter {
        ...
        void savecustomer_rating(Context context, APIResponseCallback apiResponseCallback, JSONObject requestBody);
        void rated_workers(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody,String id);
