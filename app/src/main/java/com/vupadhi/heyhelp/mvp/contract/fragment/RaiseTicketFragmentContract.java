...
public interface RaiseTicketFragmentContract {
    ...
    interface IPresenter {
        ...
        void raisetickets(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody,String id);
        void saveraisetickets(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
