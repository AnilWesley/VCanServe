...
public class ChildCareImpl extends BasePresenter implements ChildCareContract.IPresenter{

    private ChildCareContract.IView forgototp;
    private Context context;

    public ChildCareImpl(ChildCareContract.IView view, Context context) {
        super(view, context);
