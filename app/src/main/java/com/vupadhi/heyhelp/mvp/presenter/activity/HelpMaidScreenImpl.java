...
public class HelpMaidScreenImpl extends BasePresenter implements HelpMaidScreenContract.IPresenter{

    private HelpMaidScreenContract.IView forgototp;
    private Context context;

    public HelpMaidScreenImpl(HelpMaidScreenContract.IView view, Context context) {
        super(view, context);
