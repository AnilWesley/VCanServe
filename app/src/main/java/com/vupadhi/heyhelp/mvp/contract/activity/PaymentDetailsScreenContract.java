...
public interface PaymentDetailsScreenContract {
    ...
    interface IPresenter {
        ...
        void retreive_package(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void apply_coupon(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void package_selection(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody,String id);
