...
public interface ProfileFoundScreenContract {
    ...
    interface IPresenter {
        ...
        void profilefound_serreq(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody,String id);
