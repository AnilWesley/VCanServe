...
public interface SignUpActivityContract {
    ...
    interface IPresenter {
        ...
        void user_individual_locations(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void user_company_locations(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void user_register(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
