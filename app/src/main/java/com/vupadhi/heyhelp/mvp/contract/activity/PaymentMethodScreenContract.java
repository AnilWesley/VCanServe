...
public interface PaymentMethodScreenContract {
    ...
    interface IPresenter {
        ...
        void payment_method_details(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody,String id);
