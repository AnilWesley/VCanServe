...
public interface PendingPaymentfragmentContract {
    ...
    interface IPresenter {
        ...
        void pendingpay_inform(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody,String id);
