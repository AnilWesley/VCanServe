...
public interface DeploymentNotificationScreenContract {
    ...
    interface IPresenter {
        ...
        void deployment_notiflist(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody,String id);
