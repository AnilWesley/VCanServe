...
public interface PaidHistoryfragmentContract {
    ...
    interface IPresenter {
        ...
        void paidhistory_inform(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody,String id);
