...
public interface OffersfragmentContract {
    ...
    interface IPresenter {
        ...
        void promotions_offers(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody,String url);
