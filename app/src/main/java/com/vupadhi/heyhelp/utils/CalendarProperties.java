...
import com.vupadhi.heyhelp.exceptions.ErrorsMessages;
import com.vupadhi.heyhelp.exceptions.UnsupportedMethodsException;
...
public class CalendarProperties {
    ...
    public int getSelectionColor() {
        if (mSelectionColor == 0) {
            return ContextCompat.getColor(mContext, com.applandeo.materialcalendarview.R.color.defaultColor);
        }
    ...
    public int getDisabledDaysLabelsColor() {
        if (mDisabledDaysLabelsColor == 0) {
            return ContextCompat.getColor(mContext, com.applandeo.materialcalendarview.R.color.nextMonthDayColor);
        }
    ...
    public int getDaysLabelsColor() {
        if (mDaysLabelsColor == 0) {
            return ContextCompat.getColor(mContext, com.applandeo.materialcalendarview.R.color.currentMonthDayColor);
        }
