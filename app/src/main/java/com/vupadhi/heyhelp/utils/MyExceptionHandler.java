...
//import com.iprismtech.wewriteforyou.activities.HomeActivity;
...
public class MyExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, final Throwable exception) {
        ...
        intent = PendingIntent.getActivity(myContext, 0, new Intent(myContext, HomeScreenActivity.class), PendingIntent.FLAG_ONE_SHOT);
